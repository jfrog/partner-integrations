...
If you need help with this Microsoft Teams integration, please contact `support@jfrog.com`. If you need general JFrog support, you can [reach out to us on the contact form here](https://jfrog.com/contact-us/). 
...
To use the Microsoft Teams integration with an on-premise JFrog installation, the network port `8082` will need to be exposed to the external network. See [JFrog System Requirements](https://www.jfrog.com/confluence/display/JFROG/System+Requirements#SystemRequirements-RequirementsMatrix) for more information. Then when configuring the JPD, include the network port in the JPD url, e.g. `https://example.com:8082`
